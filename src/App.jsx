  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>Paste or upload ABC notation to get a fingering chart for a whistle or simple-system flute.</p>
      </header>
      ...
      <Section title="Standard Notation">
        ...
        <Notation abc={abc} onRendered={handleRendered} onError={handleNotationError} />
      </Section>
      ...
      {!error && warnings.length > 0 && (
        <div className="banner warning">
          {warnings.length} parsing warning{warnings.length > 1 ? 's' : ''}: {warnings.join('; ')}
        </div>
      )}
